...
module GoodJob
  ...
  # 
  # _@param_ `older_than` — Jobs olders than this will be deleted (default: +86400+).
  # 
  # _@return_ — Number of jobs that were deleted.
  ...
  sig { returns(T::Array[T.any(Notifier, Poller, Scheduler, MultiScheduler, CronManager)]) }
  ...
  class Poller
    TIMEOUT_INTERVAL = T.let(5, T.untyped)
  ...
  fallback_policy: :discard,
    ...
    def initialize(performer, max_threads: nil, max_cache: nil, warm_cache_on_initialize: false); end
  ...
  class CronManager
    ...
    sig { params(schedules: T::Hash[T.untyped, T.untyped], start_on_initialize: T::Boolean).void }
    def initialize(schedules = {}, start_on_initialize: false); end
    ...
    # 
    # _@param_ `cron_key` — the key within the schedule to use
    sig { params(cron_key: T.any(Symbol, String)).returns(T.untyped) }
    def create_task(cron_key); end
